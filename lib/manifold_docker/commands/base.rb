...
module ManifoldDocker
  module Commands
    class Base < ManifoldDocker::Command
      ...
      def image_exists?(image, the_version = nil)
        the_version ||= default_version
      ...
      def versioned_image(image, the_version = nil)
        the_version ||= default_version
        "#{ORG}/#{image}:#{the_version}"
      end
